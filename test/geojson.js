...
describe('Preparation des documents de couchdb', function () {
    ...
    it('should have empty features when doc is undefined', function () {
        isUndefined.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should have empty features when rows is undefined', function () {
        isWithoutRowsArray.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should have empty features when rows are empty', function () {
        isRowsEmpty.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should have empty features when rows don\'t have valid object', function () {
        isWithoutDocProp.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should have 2 documents', function () {
        isSupposedToBeValid.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should have 2 documents even with invalid couchdbProps', function () {
        isWithInvalidCouchdbProps.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
...
describe('Retirer les waypoints trop proche selon decimal', function () {
    ...
    it('should be 0 features when props are undefined', function () {
        withTwoPropsUndefined.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 features when features is undefined', function () {
        withFeaturesUndefined.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 features when features length is 0', function () {
        withFeaturesEmpty.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 features when geometry in objects are undefined', function () {
        withoutGeometryProp.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 features when coordinates in objects are undefined', function () {
        withoutCoordinatesProp.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 features when datatype is invalid', function () {
        withInvalidDataType.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 1 features the others were dupes because length was 3 and round 2', function () {
        withNumberRounded.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 2 features the others were rounded not rounded as length was 3 and round 5', function () {
        withDistinctNumber.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
...
describe('Generate Geojson document from bounds', function () {
    ...
    it('should be 2 points in document', function () {
        itShouldBeNormalRun.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 points as features was undefined', function () {
        itShouldHaveFeaturesUndefined.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 points as parms were undefined', function () {
        itShouldHaveParmsUndefined.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 points as coords were undefined', function () {
        itShouldBeEmptyAsUndefinedCoords.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 4 polygon inside the bounds', function () {
        itShouldHavePolyInside.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
    ...
    it('should be 0 polygon as coords were undefined', function () {
        itShouldNotHavePolyCoordsInvalid.should.have.property("name").and.be.exactly("IWasHere").and.be.a.String;
